"""
Official mixup implementation from "Improving Out-of-Distribution Robustness via Selective Augmentation"
https://github.com/huaxiuyao/LISA/blob/main/domain_shifts/mixup.py
"""
...
def mix_up(x, y, x2=None, y2=None):
